...
public class EmployeeInfo {
	...
	public static void main(String[] args) {
		...
		System.out.println(salComp.compare(joe1, joe2));
		
		if(salComp.compare(joe1, joe2)==0 && nameComp.compare(joe1, joe2)==0) {
...
//		
//		System.out.println("joe equals joe2? " + joe.equals(joe2));
//		EmployeeSalaryComparator s = new EmployeeSalaryComparator();
//		System.out.println("joe equals joe2? " + (s.compare(joe, joe2)==0) );
