...
//			add(new Book("48-56882", "Jimmy's First Day of School", -1, Arrays.asList(allAuthors.get(4))));	
//			add(new Book("48-56882", "Jimmy's First Day of School", -5, Arrays.asList(allAuthors.get(4))));	
		}
	};
