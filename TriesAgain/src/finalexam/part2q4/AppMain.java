...
public class AppMain {
    ...
    private static List<Integer> findExclusiveNumbers(List<Integer> l1, List<Integer> l2) {
        ...
        List<Integer> finalList = l1.stream().filter(e -> !l2.contains(e)).collect(Collectors.toList());
        finalList.addAll(l2.stream().filter(e -> !l1.contains(e)).collect(Collectors.toList()));
