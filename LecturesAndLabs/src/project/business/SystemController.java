...
public class SystemController implements ControllerInterface {
	...
	public void checkoutBook(String memberId, String isbn) throws LibrarySystemException {
		...
		LendableCopy copy = book.getNextAvailableCopy();
	...
	private Periodical searchPeriodical(String title, int issueNum) {
		DataAccess da = new DataAccessFacade();
	...
	public static void main(String[] args) {
		...
		//test computeStatus
		Book b = new Book("23-11221", "The Big Fish", 
				21, Arrays.asList((new TestData()).allAuthors.get(0), 
						(new TestData()).allAuthors.get(1)));
		BookCopy c = new BookCopy(b, 1, true);
		SystemController sc = new SystemController();
		try {
			sc.checkoutBook("1011", "23-11221");
		} catch(LibrarySystemException e) {
			e.printStackTrace();
		}
