...
public class Main {
	...
	public static <T> boolean contains1(List<T> list, T s) {
		for(T x: list) {
			...
			if(x.toString().equals(s.toString())) return true;
		}
		return false;	
	}
	...
	public static void test2() {
		...
		boolean result = Main.contains1(list, new Employee(1003, "Tom", 60000));
		System.out.println(result);
	...
	public static void test3() {
		...
		boolean result = Main.contains1(list, new Manager(1002, "Harry", 70000, 400));
		System.out.println(result);
	...
	public static void test4() {
		...
		boolean result = Main.contains1(list, new CheckingAccount(1001, 25.00));
		System.out.println(result);
